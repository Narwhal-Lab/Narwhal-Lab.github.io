const translations = {
  en: {
    ...
    "experts.card1.member1": "Guibo Luo | Assistant Professor / Researcher and Ph.D. Supervisor, Peking University",
    "experts.card1.member2": "Ahang Zuo | Associate Professor, University of Pau",
    ...
    "experts.card2.member1": "Ruoyu Su | Doctoral Researcher, University of Oulu",
    "experts.card2.member2": "Xingrui Yu | Research Scientist, A*STAR CFAR",
    ...
    "experts.card3.member1": "Xin Li | Head of Attack and Defense, Tencent Security Yunding Lab",
    "experts.card3.member2": "Dong Zhang | Lead of WuKong R&D Security, Tencent",
  ...
  zh: {
    ...
    "experts.card1.member1": "罗桂波｜北京大学信息工程学院 助理教授/研究员、博士生导师",
    "experts.card1.member2": "Ahang Zuo｜法国波城大学 副教授",
    "experts.card1.copy": "覆盖隐私协同计算、医学 AI、大模型高效部署、形式验证、数字孪生和 AI 辅助软件工程。",
    "experts.card2.badge1": "研究合作",
    "experts.card2.badge2": "Agent + 可信 AI",
    "experts.card2.title": "Ruoyu Su · Xingrui Yu",
    "experts.card2.member1": "Ruoyu Su｜芬兰奥卢大学 博士研究员",
    "experts.card2.member2": "Xingrui Yu｜新加坡科技研究局前沿人工智能研究中心 研究科学家",
    ...
    "experts.card3.member1": "李鑫｜腾讯安全云鼎实验室 攻防负责人",
    "experts.card3.member2": "张栋｜腾讯悟空研发安全负责人",
    "experts.card3.copy": "覆盖 AI Agent 安全防御、“AI 对抗 AI”的防御机制、安全免疫系统、真实攻防、代码安全、软件供应链安全和产业安全基础设施。",
    "collab.kicker": "合作",
