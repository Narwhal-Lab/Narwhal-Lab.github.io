const translations = {
  en: {
    ...
    "experts.yu.recruitment": "Research internship",
    ...
    "join.special.label": "Featured opportunity",
    "join.special.title": "A*STAR CFAR Agentic AI research internship",
    "join.special.copy": "Separate track with Visiting and CSC-related opportunities",
    ...
    "people.luo.affiliation": "Peking University",
    ...
    "people.zuo.name": "Ahang Zuo",
    "people.zuo.affiliation": "University of Pau",
    ...
    "people.su.name": "Ruoyu Su",
    "people.su.affiliation": "University of Oulu",
    ...
    "people.yu.affiliation": "A*STAR CFAR",
    ...
    "people.yu.recruitment": "Research internship",
    "people.zhang.name": "Dong Zhang",
    "people.zhang.affiliation": "Tencent WuKong",
    "people.zhang.bio": "R&D security lead at Tencent WuKong, focusing on code security, software supply-chain security, AI Agent security, LLM supply-chain security, and security infrastructure for agentic systems.",
  ...
  zh: {
    ...
    "join.special.label": "专项机会",
    "join.special.title": "A*STAR CFAR Agentic AI 研究实习生招募",
    "join.special.copy": "单独开放 Visiting 与 CSC 相关机会",
    "join.contact": "联系我们",
    ...
    "people.su.bio": "芬兰奥卢大学博士研究员，研究方向包括智能体人工智能、大语言模型、软件架构和实证软件工程。",
    "people.yu.name": "Xingrui Yu",
    "people.yu.affiliation": "新加坡科技研究局前沿人工智能研究中心",
    "people.yu.bio": "新加坡科技研究局前沿人工智能研究中心研究科学家，研究方向包括可信人工智能、鲁棒机器学习、噪声标签学习、模仿学习，以及面向代码和智能体系统的人工智能安全。",
    "people.yu.recruitment": "专项招募",
    "people.zhang.name": "张栋",
    "people.zhang.affiliation": "腾讯悟空研发安全",
    "people.zhang.bio": "腾讯悟空研发安全负责人，重点关注代码安全、软件供应链安全、智能体安全、大模型供应链安全，以及面向智能体系统的安全基础设施。",
    "people.li.name": "李鑫",
    "people.li.affiliation": "腾讯安全云鼎实验室",
    "people.li.bio": "腾讯安全云鼎实验室攻防负责人，长期深耕网络安全攻防实战与安全研究，关注智能体安全防御逻辑、人工智能对抗防御机制、安全免疫系统和攻防博弈成本控制。",
