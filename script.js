const translations = {
  en: {
    ...
    "about.copy.secondary": "Along these directions, we conduct empirical studies on real-world projects, build reproducible evaluation benchmarks, develop agent infrastructure, and explore AI-vs-AI defense and high-value application scenarios with academic and industry partners.",
    ...
    "experts.title": "Research and industry mentors connected to Narwhal Lab.",
    "experts.all": "View more people",
    "experts.card1.badge1": "Academic",
    "experts.card1.badge2": "AI + Systems",
    "experts.card1.title": "Guibo Luo · Ahang Zuo",
    "experts.card1.copy": "Privacy-preserving collaboration, medical AI, efficient large-model deployment, formal verification, digital twins, and AI-assisted software engineering.",
    "experts.card2.badge1": "Research",
    "experts.card2.badge2": "Agents + Trustworthy AI",
    "experts.card2.title": "Ruoyu Su · Xingrui Yu",
    "experts.card2.copy": "Agentic AI, LLMs, software architecture, empirical software engineering, robust machine learning, and AI safety for code and agent systems.",
    "experts.card3.badge1": "Industry",
    "experts.card3.badge2": "Real-World Security",
    "experts.card3.title": "Xin Li · Dong Zhang",
    "experts.card3.copy": "AI Agent defense, AI-vs-AI security immunity systems, attack-defense practice, code security, software supply-chain security, and industrial security infrastructure.",
  ...
  zh: {
    ...
    "about.copy.secondary": "围绕这些方向，我们开展面向真实项目的实证研究，构建可复现的评测基准，开发智能体基础设施，并与学术和产业伙伴一起探索 AI 对抗 AI 防御和高价值应用场景。",
    ...
    "research.eval.copy": "研究大模型和 Agent 系统的可靠性、安全性与可控性，包括鲁棒性评测、风险发现、工具调用安全、AI 对抗 AI 防御和安全免疫系统。",
    ...
    "experts.kicker": "成员",
    "experts.title": "连接 Narwhal Lab 研究问题、产业实践和真实场景的合作网络。",
    "experts.all": "查看更多成员",
    "experts.card1.badge1": "学术合作",
    "experts.card1.badge2": "AI + 系统",
    "experts.card1.title": "罗桂波 · Ahang Zuo",
    "experts.card1.copy": "覆盖隐私协同计算、医学 AI、大模型高效部署、形式验证、数字孪生和 AI 辅助软件工程。",
    "experts.card2.badge1": "研究合作",
    "experts.card2.badge2": "Agent + 可信 AI",
    "experts.card2.title": "Ruoyu Su · Xingrui Yu",
    "experts.card2.copy": "覆盖 Agentic AI、大语言模型、软件架构、实证软件工程、鲁棒机器学习，以及面向代码和智能体系统的 AI 安全。",
    "experts.card3.badge1": "产业专家",
    "experts.card3.badge2": "真实安全场景",
    "experts.card3.title": "李鑫 · 张栋",
    "experts.card3.copy": "覆盖 AI Agent 安全防御、AI 对抗 AI、安全免疫系统、真实攻防、代码安全、软件供应链安全和产业安全基础设施。",
    "collab.kicker": "合作",
    ...
    "join.copy": "我们欢迎本科生、硕士生、博士生、远程实习生和海外学生加入。学生可以参与 AI 代码智能、Agent 应用、Agent 数据与自进化、可信系统评测、AI 对抗 AI 防御和高价值 AI 场景等研究与工程项目。",
    ...
    "people.yu.name": "Xingrui Yu",
    "people.yu.bio": "新加坡 A*STAR 前沿人工智能研究中心研究科学家，研究方向包括可信 AI、鲁棒机器学习、噪声标签学习、模仿学习，以及面向代码和智能体系统的 AI 安全。",
    ...
    "people.li.bio": "腾讯安全云鼎实验室攻防负责人，长期深耕网络安全攻防实战与安全研究，关注 AI Agent 安全防御逻辑、AI 对抗 AI、安全免疫系统和攻防博弈成本控制。",
